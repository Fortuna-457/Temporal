...
import { ArrowLongRightIcon, GlobeAltIcon } from '@heroicons/react/24/outline'
      ...
      <div className='p-10 xs:p-0 mx-auto md:w-full md:max-w-md static z-10'>
        ...
        <form className='bg-white dark:bg-gray-800 shadow w-full rounded-lg'>
          ...
          <div className='p-5 flex flex-col gap-5'>
            <Button
              variant='outlined'
              className='flex gap-2 justify-center dark:text-gray-200'
            >
              <img
                className='h-5 mr-2'
          ...
          <div className='px-5 pb-3'>
            <div className='grid grid-cols-1 gap-1'>
              <div className='text-center sm:text-right whitespace-nowrap flex justify-end'>
                <Button
                  variant='text'
                  className='flex gap-3 dark:text-gray-200 dark:hover:bg-gray-700'
                >
